...
const fakeAvaReply = (input: string) => {
  ...
  if (input.toLowerCase().includes("react")) {
    return "Sounds like you're working with React! Do you want a React interview question?";
  }
  if (input.toLowerCase().includes("interview")) {
    return "Let’s practice! Tell me about a recent challenge you had at work and how you handled it.";
  }
